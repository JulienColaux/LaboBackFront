...
namespace API.Controllers
{
    ...
    private readonly ProductService _productService; // On creer un objet pour stocker la dependance au sevice de la BLL
        ...
        [HttpGet] //Ca indique que cette méthode sera appelé avec une requete HTTP GET
        ...
        {
            var productsSortByCategory = _productService.GetProductSortByCategory(category);
